...
function MapDataModel(title)
{
    ...
    // Highlights a marker when its associated address is clicked
    self.showMarkerForAddress = function showMarkerForAddress()
    {
        console.log("TODO: Take the title find the appropriate marker, and enable it");
    ...
    self.showListings = function showListings() {
        ...
        for (var i = 0; i < self.filteredMarkers().length; i++) {
            self.filteredMarkers()[i].setMap(map);
    ...
    self.populateInfoWindow = function populateInfoWindow(marker, infowindow) {
